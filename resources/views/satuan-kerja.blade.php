...
<body>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Data Satuan Kerja</h5>
              ...
              <div class="d-flex justify-content-between align-items-center">
                <!-- Showing Text -->
                <div class="me-3">
                  <span>Showing {{ $satuankerja->firstItem() }}-{{ $satuankerja->lastItem() }} of {{ $totalRecords }} records</span>
                </div>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <!-- Form tambah data satuan kerja -->
                      <form action="{{ route('satuankerja.store') }}" method="POST">
                        @csrf
                        <div class="mb-3">
                          <label for="kode_satuan_kerja" class="form-label">Kode Satuan Kerja</label>
                          <input type="text" class="form-control" id="kode_satuan_kerja" name="kode_satuan_kerja" required>
                        </div>
                        <div class="mb-3">
                          <label for="nama_satuan_kerja" class="form-label">Nama Satuan Kerja</label>
                          <input type="text" class="form-control" id="nama_satuan_kerja" name="nama_satuan_kerja" required>
                        </div>
  ...
  <script>
    Swal.fire({
      icon: 'error',
      text: 'Kode Satuan Kerja sudah digunakan, masukkan kode lain',
      showConfirmButton: true,
      timer: 3000
    });
  </script>
